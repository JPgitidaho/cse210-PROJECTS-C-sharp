...
static class NotificationManager
{
    ...
    {
        // Inicia el temporizador con un intervalo de 24 horas (86400000 milisegundos)
    ...
    {
        // Puedes personalizar el mensaje de la notificación motivadora
...
{
    // Inicia el temporizador de notificaciones al inicio del programa
    ...
    string input = Console.ReadLine();
        ...
        switch (input)
        {
            ...
            case "6":
                ...
                break;
            case "7": // Esta es la nueva opción "Back" para volver al inicio
                Main();
                break;
            default:
                Main();
